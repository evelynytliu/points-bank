                ...
                >
                    <div className="bg-[#fffbf0]/95 backdrop-blur-md border-t-4 border-[#4a4a4a] rounded-t-[2.5rem] p-5 pb-28 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] space-y-3 pointer-events-auto">
                        ...
                        <div className="flex gap-1.5">
                            ...
                            }} className="bg-[#edf2f4] border-[#4a4a4a]/40 text-[#4a4a4a] hover:bg-[#8d99ae] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-2 py-2 rounded-full text-xs font-black transition-all flex items-center justify-center gap-1 shadow-sm flex-1">
                                <Monitor className="w-3.5 h-3.5" /> ➔ <Star className="w-3.5 h-3.5 text-orange-400" />
                            </button>
                            <button onClick={() => {
                            ...
                            }} className="bg-[#e8f5e9] border-[#4a4a4a]/40 text-[#2e7d32] hover:bg-[#a5d6a7] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-2 py-2 rounded-full text-xs font-black transition-all flex items-center justify-center gap-1 shadow-sm flex-1">
                                <Star className="w-3.5 h-3.5 text-orange-400" /> ➔ <Monitor className="w-3.5 h-3.5" />
                            </button>
                        </div>
                    </div>
                </div>
