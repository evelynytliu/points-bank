                        ...
                        <div className="space-y-2.5">
                            ...
                            <div className="flex gap-2">
                                {[10, 20, 30].map(val => (
                                    ...
                                    }} className="bg-[#fbe9e7] border-[#4a4a4a]/40 text-[#8c3333] hover:bg-[#ff8a80] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-4 py-3 rounded-full text-base font-black transition-all flex items-center justify-center shadow-sm flex-1">
                                        -{val}
                                    </button>
                                ))}
                                <button onClick={() => showModal({ type: 'prompt', title: t.prompt_custom_deduct, onConfirm: (v) => v && onUpdate(kid, 0, -parseInt(v), t.manual_deduct, actorName) })}
                                    className="bg-[#fafafa] border-[#4a4a4a]/40 text-[#4a4a4a] hover:bg-[#4a4a4a] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-4 py-3 rounded-full text-sm font-black transition-all flex items-center justify-center shadow-sm flex-1">
                                    {t.custom}
                                </button>
                            </div>
                            ...
                            <div className="flex gap-2 items-center">
                                ...
                                }} className="bg-[#edf2f4] border-[#4a4a4a]/40 text-[#4a4a4a] hover:bg-[#8d99ae] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-4 py-3 rounded-full text-sm font-black transition-all flex items-center justify-center gap-2 shadow-sm flex-1">
                                ...
                                }} className="bg-[#e8f5e9] border-[#4a4a4a]/40 text-[#2e7d32] hover:bg-[#a5d6a7] hover:text-white hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 px-4 py-3 rounded-full text-sm font-black transition-all flex items-center justify-center gap-2 shadow-sm flex-1">
                                    <Star className="w-4 h-4 text-orange-400" /> ➔ <Monitor className="w-4 h-4" />
                                </button>
                                <button
                                    onClick={() => setIsMenuOpen(false)}
                                    className="bg-[#ff8a80] border-[#4a4a4a]/40 text-white hover:bg-[#ff6b6b] hover:-translate-y-0.5 border-b-3 active:border-b-0 active:translate-y-0.5 w-14 h-14 rounded-full transition-all flex items-center justify-center shadow-sm shrink-0">
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                        </div>
