...
const rawTranslations = {
    ...
    parent_pin_desc: ['當以小孩帳號試圖增加權益(加分/加時)時，需輸入此 PIN 碼。', 'Required when adding points/time from a kid account.'],
    parent_pin_label: ['家長 PIN 碼', 'Parent PIN'],
    parent_pin_sub: ['管理權限驗證密碼', 'Admin Verification PIN'],
    enable_pin_sub: ['啟用時，以小孩帳號操作加點或加時間時，會要求輸入 PIN 碼。', 'When enabled, adding points/time as a kid requires PIN.'],
